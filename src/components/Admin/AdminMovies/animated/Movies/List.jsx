...
import { deleteAnimeMovie } from "../../../../../action/movies/animated/Mov";
      ...
      <div className="tariler-data-list-detail">
        <table className="trailer-table">
          <tr>
            ...
            <td>{data?.name}</td>
            <td>
              <i className="fas fa-pen" onClick={()=>setCurrentId(data?._id)}  ></i> <i className="fas fa-trash" onClick={()=>dispatch(deleteAnimeMovie(data?._id))} ></i>
            </td>
        </tr>
            ))
        }
