...
import { createMovies, updateMovies } from "../../../../action/Movies";
...
const Cards = ({ data, setData, currentId, setCurrentId }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (currentId) {
      dispatch(updateMovies(currentId, {...movieData,name:user?.result?.name}));
    } else {
      dispatch(createMovies({...movieData,name:user?.result?.name,datatype:'trend'}));
    }
    clear();
  };
