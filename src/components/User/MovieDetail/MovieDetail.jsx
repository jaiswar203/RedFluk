...
const MovieDetail = () => {
  ...
  function Trailerremove(){
    ...
    if(iframe_vid){ // to stop embed video on click
    ...
    <>
      ...
      <div className="movies-details">
        <div className="movies-details-para">
          <p>
            <strong>Genre: </strong>
            <a href="/details">{detail.genre.map((p,i)=> i===0 ? p : `,${p}`)}</a>
          </p>
          <p>
      ...
      <div className="movies-links">
        <div className="movies-links-google">
          ...
          <div className="movies-links-link">
            ...
            <Link to={`/download/trendmovies/${id}?quality=720p`}>
              <button>
                {" "}
                <i className="fas fa-download"></i> 720p
              </button>
            </Link>
            <Link to={`/download/trendmovies/${id}?quality=1080p`}>
              <button>
                {" "}
                <i className="fas fa-download"></i> 1080p
              </button>
