...
import { filterAction } from '../../../../action/filter/movies';
...
const Genre = () => {
  const {Action}=useSelector((state)=>state.filterMovie)
  const query=useQuery()
  const dispatch=useDispatch()
  const {actiontotalPages}=useSelector((state)=>state.filterMovie)
